    ...
    $(function () {
        ...
        uploader.onUploadSuccess = function (file, response) {
            ...
            $photo_container.off().append('<input type="hidden" name="photos[' + photo_sequence + '].path" value="' +
                ...
                (photo_width * 10) + '"/>').append('<input type="hidden" name="photos[' + photo_sequence + '].height" value="' +
                ( photo_height * 10) + '"/>');

            $("#upload-cover-container").append(
                '<div style="float: left; margin: 2px; padding: 2px; border: 1px dashed; width:' +
                ' 120px; height: 100px;">' +
                '<span><img src="'+photo_path+'"title="待选封面" width="'+photo_width+'" height="'+photo_height+'" />' +
